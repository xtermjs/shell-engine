...
describe('Shell', () => {
  ...
  describe('keybindings', () => {
    beforeEach(async () => {
      ...
      strictEqual(shell.prompt.inputCursorIndex, 5);
      await lastWritePromise;
    ...
    it('ctrl+f      - move one character forward', async () => {
      ...
      strictEqual(shell.prompt.inputCursorIndex, 6);
    ...
    it('ctrl+b      - move one character back', async () => {
      shell.write('\x02');
      await assertBuffer('$ foo bar baz');
      strictEqual(shell.prompt.inputCursorIndex, 4);
    ...
    it('ctrl+a      - move to the start of the command line', async () => {
      shell.write('\x01');
      await assertBuffer('$ foo bar baz');
      strictEqual(shell.prompt.inputCursorIndex, 0);
    ...
    it('ctrl+e      - move to the end of the command line', async () => {
      shell.write('\x05');
      await assertBuffer('$ foo bar baz');
      strictEqual(shell.prompt.inputCursorIndex, 11);
    ...
    it('alt+f       - move one word forward', async () => {
      shell.write('\x1bf');
      await assertBuffer('$ foo bar baz');
      strictEqual(shell.prompt.inputCursorIndex, 6);
      strictEqual(term.buffer.active.cursorX, 8);
    });
    it('ctrl+right  - move one word forward', async () => {
      shell.write('\x1b[1;5C');
      await assertBuffer('$ foo bar baz');
      strictEqual(shell.prompt.inputCursorIndex, 6);
      strictEqual(term.buffer.active.cursorX, 8);
    });
    it('alt+b       - move one word backward', async () => {
      shell.write('\x1bb');
      await assertBuffer('$ foo bar baz');
      strictEqual(shell.prompt.inputCursorIndex, 4);
      strictEqual(term.buffer.active.cursorX, 6);
    });
    it('ctrl+left   - move one word backward', async () => {
